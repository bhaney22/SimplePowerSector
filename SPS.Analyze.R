...
##########################################################################################
Eta.1.f           <- levels(as.factor(DF.results.f$Eta.1))
Eta.2.f           <- levels(as.factor(DF.results.f$Eta.2))
Eta.3.f           <- levels(as.factor(DF.results.f$Eta.3))
Eta.4.f           <- levels(as.factor(DF.results.f$Eta.4))
Res.1.price.f     <- levels(as.factor(DF.results.f$Res.1.price))
Res.2.price.f     <- levels(as.factor(DF.results.f$Res.2.price))
Fin.1.price.f     <- levels(as.factor(DF.results.f$Fin.1.price))
Fin.2.price.f     <- levels(as.factor(DF.results.f$Fin.2.price))
Fin.1.Mkt.share.f <- levels(as.factor(DF.results.f$Fin.1.Mkt.share))
Fin.1.I.1.share.f <- levels(as.factor(DF.results.f$Fin.1.I.1.share))
Fin.1.I.2.share.f <- levels(as.factor(DF.results.f$Fin.1.I.2.share))
Fin.1.I.3.share.f <- levels(as.factor(DF.results.f$Fin.1.I.3.share))
Fin.2.I.1.share.f <- levels(as.factor(DF.results.f$Fin.2.I.1.share))
Fin.2.I.2.share.f <- levels(as.factor(DF.results.f$Fin.2.I.2.share))
Fin.2.I.3.share.f <- levels(as.factor(DF.results.f$Fin.2.I.3.share))
